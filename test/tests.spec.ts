...
describe("node-saml /", function () {
  describe("saml.js / ", function () {
    ...
    describe("validatePostResponse checks /", function () {
      ...
      [true, ValidateInResponseTo.always, ValidateInResponseTo.ifPresent].forEach(
    ...
    describe("InResponseTo validation checks /", () => {
      ...
      [true, ValidateInResponseTo.always].forEach((validateInResponseTo) => {
        describe(`when validateInResponseTo is set to ${validateInResponseTo} /`, () => {
      ...
      [false, ValidateInResponseTo.ifPresent, ValidateInResponseTo.never].forEach(
        (validateInResponseTo) => {
          describe(`when validateInResponseTo is set to ${validateInResponseTo}`, () => {
      ...
      [false, ValidateInResponseTo.never].forEach((validateInResponseTo) => {
        describe(`when validateInResponseTo is set to ${validateInResponseTo}`, () => {
