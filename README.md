...
- `wantAuthenticationResponseSigned`: if true, require that all incoming authentication response messages be signed at the top level, not just at the assertions. This is a good idea to turn on; it is off by default.
