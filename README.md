...
- `metadataExtensions`: Optional, this parameters can be used to include more metadata in the XML generated by `generateServiceProviderMetadata`. There are many possible values for the `metadataExtensions` element. You can check the type definitions for help.
