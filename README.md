...
| `authnContext`                   | `["urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport"]` | Requested authentication context class(es). A single string is also accepted.                                                                                                                                       |
